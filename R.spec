...
Version  : 3.3.3
Release  : 64
URL      : http://cran.cnr.berkeley.edu/src/base/R-3/R-3.3.3.tar.gz
Source0  : http://cran.cnr.berkeley.edu/src/base/R-3/R-3.3.3.tar.gz
...
%build
export LANG=C
export SOURCE_DATE_EPOCH=1488811410
unset LD_AS_NEEDED
export CFLAGS="$CFLAGS -O3 -falign-functions=32 -fno-semantic-interposition -march=sandybridge "
export FCFLAGS="$CFLAGS -O3 -falign-functions=32 -fno-semantic-interposition -march=sandybridge "
export FFLAGS="$CFLAGS -O3 -falign-functions=32 -fno-semantic-interposition -march=sandybridge "
export CXXFLAGS="$CXXFLAGS -O3 -falign-functions=32 -fno-semantic-interposition -march=sandybridge "
